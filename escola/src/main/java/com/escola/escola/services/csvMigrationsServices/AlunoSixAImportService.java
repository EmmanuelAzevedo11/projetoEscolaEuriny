...
@Component
public class AlunoSixAImportService implements CommandLineRunner {

    private final UserRepository userRepository;
    private final PasswordEncoder passwordEncoder;

    public AlunoSixAImportService(UserRepository userRepository, PasswordEncoder passwordEncoder){
    ...
    public void run(String ...args) throws Exception{
        boolean response = userRepository.existsByTeam("6a");
        ClassPathResource resource = new ClassPathResource("csvMigrations/listaAlunosSixA.csv");
        if(response == false) {
            ...
            try (BufferedReader bufferedReader = new BufferedReader(new
                ...
                while ((linha = bufferedReader.readLine()) != null) {
                    ...
                    if (colunas.length >= 7) {
                        ...
                        String ra = colunas[2].trim();
                        String digitoRa = colunas[3].trim();
                        String situacao = colunas[6].trim();
                        ...
                        if ("Ativo".equalsIgnoreCase(situacao)) {
                            if (userRepository.findByRa(ra).isEmpty()) {
                                ...
                                aluno.setTeam("6a"); // Seta ANTES do save
